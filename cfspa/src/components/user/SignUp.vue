  ...
  computed: {
    nameErrors() {
      ...
      !this.$v.user.name.required &&
        errors.push(this.$t("errors.required", [this.$t("user.name")]));
      return errors;
    },
    lastnameErrors() {
      const errors = [];
      if (!this.$v.user.lastname.$dirty) return errors;
      !this.$v.user.lastname.maxLength &&
        errors.push(
          this.$t("errors.maxLength", [
            this.$t("user.lastname"),
            this.$v.user.name.$params.maxLength.max
          ])
        );
      !this.$v.user.lastname.required &&
        errors.push(this.$t("errors.required", [this.$t("user.lastname")]));
      return errors;
    },
    emailErrors() {
      const errors = [];
      ...
      !this.$v.user.email.required &&
        errors.push(this.$t("errors.required", [this.$t("user.email")]));
      return errors;
    },
    passwordErrors() {
      const errors = [];
      ...
      !this.$v.user.password.required &&
        errors.push(this.$t("errors.required", [this.$t("user.password")]));
      return errors;
    },
    confirmPasswordErrors() {
      ...
      !this.$v.confirmPassword.sameAsPassword &&
        errors.push(this.$t("errors.passwordsDoesNotMatch"));
      return errors;
    },
    organizationErrors() {
      const errors = [];
      if (!this.$v.user.organization.$dirty) return errors;
      !this.$v.user.organization.required &&
        errors.push(this.$t("errors.required", [this.$t("user.organization")]));
      return errors;
    },
    termsErrors() {
      const errors = [];
      if (!this.$v.user.terms.$dirty) return errors;
      !this.$v.user.terms.required &&
        errors.push(this.$t("errors.acceptTermsRequired"));
      return errors;
    }
  },
  created() {
